...
@section('content')
            ...
            <nav class="ps-lg-5 pe-lg-5 ps-md-5 pe-md-5 pt-3 pb-3 navbar navbar-expand-lg navbar-light">
                <div class="container-fluid p-0">
                    ...
                    <div>
                        ...
                        <span>
                            <a class="navbar-link  mylist active" href="{{ route('show') }}">
    ...
    <div class="container mb-5 mt-5">
        ...
        <div class="row mt-3 ">
            <div class="col-lg-5 col-12 text-center" style="max-height: 690px;
            overflow: auto;">
                ...
                <div class="container mesages-row" id="dataContainer">
                    ...
                    {{-- <div class="row">
                        <div class="col-5 offset-7">
                            <p class="chat-ms-rec">Hey There I need a help from you</p>
                        </div>
                    </div> --}}
                    {{-- <div class="row ">
                        <div class="col-5">
