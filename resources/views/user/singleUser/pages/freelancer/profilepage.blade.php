...
<div class="container mb-5 mt-5">
    ...
    <div class="row mt-3 ">
        ...
        <div class="col-lg-6 ps-4 pe-4 mt-md-4 mt-lg-0 mb-sm-4 mt-lg-0 mt-xs-4 col-12" style="background-color: #F9F9F9;  border-radius: 21.0305px;">
            <div class="pr-2 pl-2">
                    ...
                    <div class="row">
                        <div class="col-lg-12 mt-3 mb-3 pt-3 pb-3 res" style="background: #FFFFFF;;border-radius: 20px;">
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <p class="single-job-heading" style="margin: 0;"><b>{!! $service->title ?? '' !!}</b></p>
                            ...
                            <div class="jobviewbtns mt-1 mb-1">
                                <a href="{{ route('edit.service', $service->id) }}"><button class="buttonfill-apply">Edit Service</button></a>
                                 
                                @if($service->status == 1)
                                    <a href="{{ route('pouse.service',$service->id) }}" ><button class="buttonunfill-save">Pause for now</button></a>
                                @else
                                <a href="{{ route('pouse.service',$service->id) }}" ><button class="buttonunfill-save">Enable</button></a>
                                @endif
