        ...
        <div class="container-fluid p-0">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0 profile_list">
              <li><a href="../Freelancer/Bussines.html" class="mylist">Businesses</a></li>
              <li><a href="../Freelancer/freelancerdiffcarddesi.html" class="mylist">Freelancers</a></li>
              <li><a href="./Bussines4.html" class="mylist active">Settings</a></li>
            </ul>
            <div>
                ...
                <div class="col-lg-12 mt-3 mb-3 pt-3 pb-3 res" style="background: #FFFFFF;;border-radius: 20px;">
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-9 col-7">
                             <p class="single-job-heading" style="margin: 0; padding: 0 20px;"><b> Lorem Ipsum </b></p>
