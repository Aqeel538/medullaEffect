                ...
                <form action="{{ route('individual.create')}}" method="POST" class="needs-validation" novalidate="">
                    ...
                    <div class="row justify-content-center Poppins">
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="name" class="form-control padd_12_input ps-0 border border-0"
                    ...
                    <div class="row justify-content-center Poppins">
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="phone" class="form-control ps-0 border border-0 padd_12_input"
                                    style="border-left: none; background-color: rgba(244, 244, 244, 1);"
                    ...
                    <div class="pt-4">
                        <p class="Halvetica phara_16 mb-0" style="font-weight: 700;">Already have an account? <span
                                class="log_company"><a href="#">Log In</a></span></p>
                    </div>
            ...
            <form action="" method="POST">
                ...
                <div class="row justify-content-center Poppins">
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="input-group mb-3">
                            ...
                            <input  type="email" name="email" class="form-control padd_12_input ps-0 border border-0" style="border-left: none; background-color: rgba(244, 244, 244, 1);" placeholder="Email ID">
                ...
                <div class="row justify-content-center Poppins">
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="input-group mb-3">
                            ...
                            <input   type="text" name="password" class="form-control ps-0 border border-0 padd_12_input" style="border-left: none; background-color: rgba(244, 244, 244, 1);" placeholder="Enter Password">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="input-group mb-3">
                            ...
                            <input   type="text" name="address" class="form-control ps-0 border border-0 padd_12_input" style="border-left: none; background-color: rgba(244, 244, 244, 1);" placeholder="Address">
                        </div>
                    </div>
                ...
                <div class="row justify-content-center Poppins">
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="input-group mb-3">
                            ...
                            <input   type="text" name="company_name" class="form-control ps-0 border border-0 padd_12_input" style="border-left: none; background-color: rgba(244, 244, 244, 1);" placeholder="Company Name">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="input-group mb-3">
                            <span class="input-group-text phara_16 border border-0" style="background-color: rgba(244, 244, 244, 1);"><i class="fa-regular fa-user"></i></span>
                            <input   type="text" name="website" class="form-control ps-0 border border-0 padd_12_input" style="background-color: rgba(244, 244, 244, 1); border-left: none;" placeholder="Website (optional)">
                        </div>
                    </div>
                ...
                <div class="row justify-content-center Poppins">
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="input-group mb-3">
                            <span class="input-group-text phara_16 border border-0" style="background-color: rgba(244, 244, 244, 1);"><i class="fa-solid fa-phone"></i></span>
                            <input   type="text" name="phone" class="form-control ps-0 border border-0 padd_12_input" style="border-left: none; background-color: rgba(244, 244, 244, 1);" placeholder="Phone Number">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-12 dropdown">
                        <div class="input-group mb-3">
                            <span class="input-group-text phara_16 border border-0" style="background-color: rgba(244, 244, 244, 1);"><i class="fa-regular fa-user"></i></span>
                            <input   type="text" name="industry" class="form-control ps-0 border border-0 padd_12_input" style="background-color: rgba(244, 244, 244, 1); border-left: none;" placeholder="Industry">
                ...
                <div class="row justify-content-center Poppins">
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="input-group mb-3">
                            <span class="input-group-text phara_16 border border-0" style="    background-color: rgba(244, 244, 244, 1);"><i class="fa-regular fa-user"></i></span>
                            <input   type="text" name="contact" class="form-control ps-0 border border-0 padd_12_input" style="background-color: rgba(244, 244, 244, 1); border-left: none;" placeholder="Source of Contact">
                            <button type="button" class=" dropdown-toggle drop_btn border border-0" style="    background-color: rgba(244, 244, 244, 1);" data-bs-toggle="dropdown" aria-expanded="false">
                                <span class="visually-hidden">Toggle Dropend</span>
                            </button>
                            <ul class="dropdown-menu">
