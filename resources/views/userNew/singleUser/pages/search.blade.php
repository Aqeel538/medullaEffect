            ...
            <div class="headers">
                <nav class="navbar-questionare3">
                    ...
                    <ul class="navbar-lists" id="myDIV">
                        ...
                        <li><a class="navbar-link" href="{{ route('index') }}#service">Services</a></li>
                        <li><a class="navbar-link" href="{{ route('index') }}#faqs">FAQ's</a></li>
                        <li><a class="navbar-link" href="{{ route('index') }}#contactUs">Contact</a></li>
                ...
                <div class="row industry-dropdown-input">
                    <div class="col-lg-5 col-md-4 col-12">
                        <div class="inpus-industry">&nbsp;
                            <i class="fa-solid fa-industry"></i>
                            <div class="">
                                <input list="browsers" name="industry" class="widths" placeholder="Job Title" />
                            </div>
            ...
            <div class="row mt-5 mb-3">
                @foreach ($results as $result)
                    <div class="col-lg-4 col-md-6 col-12  mt-lg-0 mt-md-0 mt-3 ">
                        <a href="{{ route('individual.jodDetails', $result->id) }}">
                            <div class=" job-posted-radius">
                                <div class="cards-scroll p-3 mt-3 ">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-9 col-7">
                                            ...
                                            <p class="job-posted" style="margin: 0; padding-left:35px;">
                                                {!! $result->located_in ?? '' !!} <span
                                                    class="text-reds">({!! $result->job_type ?? '' !!})</span></p>
                                    ...
                                    pt-3"
                                            ...
                                            {!! $result->description ?? 'There is no description' !!}</p>
                                    </div>
