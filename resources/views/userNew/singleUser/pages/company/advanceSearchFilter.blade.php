    ...
    <div class="container-fluid tagline-1">
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-7 col-sm-9 col-12 text-center">
                ...
                <p class="mt-4 mb-5 jjohn-para-afer-ques-heading-filter">
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-lg-9 col-md-8 col-10">
                    <div class="row">
                        <div class="col-lg-4 col-md-12 col-12 mmb-lg-0 mb-md-2 mb-3">
                        ...
                        <div class="col-lg-4 col-md-12 col-12 mb-lg-0 mb-md-2 mb-3 xs-res">
                            <div class="inputfield-2">
                        ...
                        <div class="col-lg-4 col-md-12 col-12 mb-lg-0 mb-md-2 mb-3">
                            <div class="inputfield-2">
                    ...
                    <div class="row mt-lg-3 mt-md-0 mt-2">
                        ...
                        <div class="col-lg-4 col-md-12 col-12 mb-lg-0 mb-md-2 mb-3xs-res">
                            <div class="inputfield-2">
