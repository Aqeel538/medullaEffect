...
<div class="content-wrapper">
    <div class="row">
        ...
        <div class="card-body">
            ...
            <form class="forms-sample" action="{{ route('jobs_editstore') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input value="{{$jobs->title}}" required type="text" name="title" class="form-control" id="exampleInputUsername1" placeholder="Fill for tag">
                </div>
                <div class="form-group">
                    <label for="exampleInputUsername1">Service Discription</label>
                    <input value="{{$jobs->discription}}" required type="text" name="discription" class="form-control" id="exampleInputUsername1" placeholder="Fill for tag">
                </div>
                <div class="form-group">
                    <label for="exampleInputUsername1">Service Image</label>
                    <img alt="Image" style="height: 200px; width: auto;" src="{{ asset('uploads/ServiceImages') . '/' . $jobs->image}}">
